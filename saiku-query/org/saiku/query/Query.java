...
public class Query {
	...
	private String dateMdx = "{[日期].[日期].[日期].Members}";  //zst update on 20160802
	 ...
	 * zst create 20160802
	 * */
	public String restrictMdxDate(String mdx) {
		...
		if(mdx.contains(dateMdx)) {
			mdx = mdx.replace(dateMdx, newDateMdx);
    	} else if(!mdx.contains("日期")) {
    		
	    		String sub = mdx.split("WITH")[1];
	    		StringBuffer buff = new StringBuffer();
	    		buff.append("WITH");
	    		buff.append("\n");
	    		buff.append("SET [~COLUMNS_日期_日期] AS");
	    		buff.append("\n");
	    		buff.append("    ");
	    		buff.append(newDateMdx);
	    		buff.append(sub);
