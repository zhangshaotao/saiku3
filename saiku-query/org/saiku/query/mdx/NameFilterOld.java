...
public class NameFilterOld extends AbstractFilterFunction {

	private List<String> filterExpression = new ArrayList<String>();
	private MdxFunctionType type;
	private Hierarchy hierarchy;

	public NameFilterOld(Hierarchy hierarchy, String... matchingExpression) {
	...
	public NameFilterOld(Hierarchy hierarchy, List<String> matchingExpression) {
		this.hierarchy = hierarchy;
